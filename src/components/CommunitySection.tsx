  ...
  return (
    <div className="w-full h-fit grid relative md:grid-cols-7 items-center  gap-6 py-6 px-6  lg:py-12 lg:px-12 bg-primary rounded-xl">
      <div className="w-full flex flex-col md:col-span-5 gap-4 lg:gap-6">
        ...
        <p className="text-white dark:text-gray-500 text-sm lg:text-base w-full lg:w-[70%] leading-relaxed">
          Unlock your true potential and discover a world of opportunities that
          align with your skills, interests, and aspirations
        </p>
        <Button className="flex h-11 text-sm  mt-4 lg:mt-0 hover:bg-white hover:text-primary dark:hover:bg-primary-foreground dark:hover:text-white  w-fit bg-black text-white items-center   font-medium  justify-center px-5">
          Get started now
        </Button>
      </div>
